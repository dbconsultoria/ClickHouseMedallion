  ...
  insert into `silver`.`silver_products`
        ("code", "description", "sale_value", "is_active", "category_code", "category_description", "_ingested_at", "_normalized_at")
